...
MyClass.prototype.add = middlewareDecorator(
    function (a, b) { console.log(`Before: ${a}, ${b}`); },
    function (result) { console.log(`After: ${result}`); }
)(MyClass.prototype, 'add', Object.getOwnPropertyDescriptor(MyClass.prototype, 'add'));
